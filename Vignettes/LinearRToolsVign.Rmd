...
```
Our original function does work much faster; However, I have adapted the function so that way it works with high multicollinearity instead of returning an error as shown in our provided test cases. So the slower time is the drawback.
